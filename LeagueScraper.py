...
#print(get_current_match_time(nightblue))
#print("length of match history: " + str(len(dolphinos.match_history)))
print("Dolphinos has played ", get_timeplayed(dolphinos, 168), " seconds in the past 168 hours")
print("Dolphinos has played ", get_timeplayed(dolphinos, 24), " seconds in the past 24 hours")